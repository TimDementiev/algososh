...
export const CY_CIRCLE_HEAD = "[data-cy=head]";
export const CY_CIRCLE_CIRCLE = "[data-cy=circle]";
export const CY_CIRCLE_LETTER = "[data-cy=letter]";
export const CY_CIRCLE_INDEX = "[data-cy=index]";
